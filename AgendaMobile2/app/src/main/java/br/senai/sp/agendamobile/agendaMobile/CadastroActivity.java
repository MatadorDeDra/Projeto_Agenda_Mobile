            ...
            switch (item.getItemId()){
                case R.id.menu_salvar:
                    ...
                    if(contato.getId() !=0){
                        ...
                        dao.salvar(contato);
                        Toast.makeText(CadastroActivity.this,  " contato salvo", Toast.LENGTH_LONG).show();
                    }
            ...
            case R.id.menu_deletar:
                ...
                if(contato.getId() != 0){
                    new AlertDialog.Builder(this).setTitle("deletar contato").
                            setMessage("tem certeza que quer deletar o contato " + contato.getNome()+ " ?")
                    ...
                    Toast.makeText(CadastroActivity.this,   "Não é póssivel apagar um contato inexistente", Toast.LENGTH_LONG).show();
                }
        }
